...
var RouteLoader = require('./RouteLoader-e8575dfd.js');
    ...
    case routing.SET_ENTRY:
      {
        ...
        if (!entry) {
          ...
          if (mappedEntry && Object.keys(mappedEntry).length > 0) nextState = nextState.set('mappedEntry', require$$0.fromJS(mappedEntry)).set('entry', require$$0.fromJS({
            sys: entry.sys
          }));
        }
...
function* setRouteEntry(entry, node, ancestors, siblings, entryMapper, notFound = false) {
  ...
  const currentMappedEntry = yield effects.select(routing.selectMappedEntry);
...
//# sourceMappingURL=App-625b19b8.js.map
